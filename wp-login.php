...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Suresby &#8211; Help Desk &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.0.2" media="all">
	...
	<link rel="icon" href="/wp-content/uploads/2022/08/MicrosoftTeams-image-26-144x144.png" sizes="32x32">
<link rel="icon" href="/wp-content/uploads/2022/08/MicrosoftTeams-image-26.png" sizes="192x192">
<link rel="apple-touch-icon" href="/wp-content/uploads/2022/08/MicrosoftTeams-image-26.png">
<meta name="msapplication-TileImage" content="/wp-content/uploads/2022/08/MicrosoftTeams-image-26.png">
	</head>
	<body class="login no-js login-action-login wp-core-ui  locale-en-us">
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		<div id="login">
		<h1><a href="https://wordpress.org/">Powered by WordPress</a></h1>
	<div id="login_error">	<strong>Error</strong>: Invalid username, email address or incorrect password.<br>
</div>

		<form name="loginform" id="loginform" action="https://172.31.0.40/wordpress/wp-login.php" method="post">
			<p>
				<label for="user_login">Username or Email Address</label>
				<input type="text" name="log" id="user_login" autocomplete="off" aria-describedby="login_error" class="input" value="" size="20" autocapitalize="off">
			</p>

			<div class="user-pass-wrap">
				<label for="user_pass">Password</label>
				<div class="wp-pwd">
					<input type="password" name="pwd" id="user_pass" autocomplete="off" aria-describedby="login_error" class="input password-input" value="" size="20">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="https://172.31.0.40/wordpress/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Suresby &#8211; Help Desk</a>		</p>
			</div>
			<script src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">var _zxcvbnSettings = {"src":"https172.31.0.40\/wordpress\/wp-includes\/js\/zxcvbn.min.js"};</script>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"1624dba0e1"};</script>
